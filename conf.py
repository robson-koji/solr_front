...
COLLECTIONS = {
    ...
    'graph_auxilios': {
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                {'label':'Situação' , 'render':'halfPieChart',  'facets':[{'chave':'situacao', 'label': 'Situação'}] },#, 'situacao_en_exact']},
                {'label':'Bolsas' , 'render':'halfPieChart',  'facets':[{'chave':'bolsas_pt', 'label': 'Bolsas'}] },#, 'situacao_en_exact']},
                {'label':'Auxilios' , 'render':'barChart_1', 'facets':[{'chave':'auxilio_pesquisa_pt', 'label': 'Auxílios a Pesquisa'}] },#, 'situacao_en_exact']},
            ]},
            {'groupBy':{'id':'area', 'label':'Área','order':1},
            'facetGroup':[
                {'label':'Área do conhecimento' , 'render':'barChart_1',  'facets':[{'chave':'area_pt','label':'Área do conhecimento'}]},# 'area_conhecimento_exact', 'area_exact''area_conhecimento_en_exact']},
                {'label':'Instituição-Sede' , 'render':'barChart_1',  'facets':[{'chave':'entidade_exact','label':'Entidade'}]},#,'sigla_instituicao_exact',  'unidade_exact' 'sigla_unidade_exact','instituicao_exact', 'id_instituicao_sede_exact',]},
            ]},
            {'groupBy':{'id':'acordos', 'label':'Acordos e Convênios','order':2},
            'facetGroup':[
                {'label':'Convênios e Acordos' , 'render':'barChart_1', 'facets':[ {'chave':'tipo_convenio_exact','label':'Tipo de convenio'},{'chave':'convenio_exact','label':'Convenio'},{'chave':'pais_convenio_exact','label':'País de convenio'}]},
            ]},
            ...
            'facetGroup':[
                {'label':'Geolocalização Exterior' ,  'render':'barChart_1', 'facets':[#{'chave':'cidade_exterior_lat_lon_exact','label':'Cidades no exterior'}, {'chave':'conexao_cidade_sp_exterior_exact','label':'Conexões da cidade de sp com exterior'},{'chave':'pais_exterior_lat_lon_exact','label':'País no exterior'}, {'chave':'conexao_pais_sp_exterior_exact', 'label':'Conexao do pais com exterior'},
                                                                  ...
                                                                  {'chave':'cidade_exact','label': 'Cidade de origem'}]}, #{'chave': 'cidade_lat_lon_exact','label':'Cidade Latitude Longitude '},
            ]},
            {'groupBy':{'id':'temporal', 'label':'Série Temporal','order':5},
            'facetGroup':[
                {'label':'Série Temporal' , 'render':'', 'facets':[{'chave':'ano_inicio','label':'Ano de início'}]},# {'chave':'data_termino_mes_exact','label':'Mês de término'}, {'chave':'data_inicio_ano_exact','label':'Ano de inicio'}, {'chave':'data_termino_ano_exact','label':'Ano de termino'}, {'chave':'ano_exact','label':'Ano'}]},
            ]},
            ...
            'facetGroup':[
                {'label':'Programas' , 'facets':[{'chave':'programa_tema_pt','label':'Por tema'}, {'chave':'programa_aplicacao_pt','label':'Aplicação'}, {'chave':'programa_percepcao_pt','label':'Percepção'}, {'chave':'programa_infra_pt', 'label':'Infra' } ]},
            ]},
        ...
        'totalizadores':[
            ...
            {'label':'Bolsas no Brasil - Em andamento' , 'facet':{'fomento':['Bolsas*no*Brasil*'], 'situacao':["Em andamento"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'], 'order':13},
            {'label':'Bolsas no Brasil - Concluídas' , 'facet':{'fomento':['Bolsas*no*Brasil*'], 'situacao':["Concluídos"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'],  'order':14},
            {'label':'Bolsas no Exterior - Em andamento' , 'facet':{'fomento':["Bolsas*no*Exterior*"], 'situacao':["Em andamento"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'],  'order':15},
            {'label':'Bolsas no Exterior - Concluídas' , 'facet':{'fomento':["Bolsas*no*Exterior*"], 'situacao':["Concluídos"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'],  'order':16},
            {'label':'Auxílios - Em andamento' , 'facet':{'auxilio':["*"], 'situacao':["Em andamento"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'],  'order':11},
            {'label':'Auxílios - Concluídos' , 'facet':{'auxilio':["*"], 'situacao':["Concluídos"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'titulo_pt_t'},'type':['doc', 'main'],  'order':12},


            {'label':'Com Publicações Científicas' , 'facet':{'publicacoes_cientificas_exact':["Sim"]}, 'docs':{},'type':['secondary'], 'order':2},
            {'label':'Com Publicações Acadêmicas' , 'facet':{'publicacoes_academicas_exact':["Sim"]}, 'docs':{},'type':['secondary'], 'order':3},
            {'label':'Com Matéria na Revista FAPESP' , 'facet':{'materias_revista_exact':["Sim"]}, 'docs':{},'type':['secondary'], 'order':4},
            {'label':'Com Matéria na Agência FAPESP' , 'facet':{'materias_agencia_exact':["Sim"]}, 'docs':{},'type':['secondary'], 'order':5},
    ...
    'bv_memoria':{
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                {'label':'Ano de publicacao' , 'render':'', 'facets':[{'chave':'ano_publicacao', 'label': 'Ano de publicacao'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1',  'facets':[{'chave':'auxilio_pesquisa_pt','label':'Auxílios'}]},
                {'label':'' , 'render':'barChart_1',  'facets':[{'chave':'bolsas_pt','label':'Bolsas'}]},
            ]},
        ],
        'totalizadores':[
            {'label':'Publicações Científicas - Com link interno' , 'facet':{'absolute_url_pt_t':["*"]}, 'docs':{'url':'absolute_url_pt_t', 'text':'referencia'}, 'type':['doc', 'main'], 'colunas': 12, 'order':1},
            {'label':'Citações' , 'sum':'numero_citacoes', 'order':2, 'docs':{}, 'type':['main']},
            {'label':'Revistas' , 'unique':'revista', 'order':3, 'docs':{}, 'type':['main']},
        ],
    },
    'memoria_autoria':{
        'omite_secoes':['documentos', 'busca', 'refine', 'sankey'], # Caso nao queira uma determinada secao no buscador.
        ...
        'facets_categorias':[
            {'groupBy':{'id':'class', 'label':'Classificação','order':1},
            'facetGroup':[
                {'label':'Instituição' , 'render':'datas', 'facets':[{'chave':'instituicao_list_exact', 'label': 'Instituição do Autor'}]},
                {'label':'País' , 'render':'barChart_1', 'facets':[{'chave':'pais_list_exact', 'label': 'País da Instituição'}]},
                {'label':'Autor' , 'render':'barChart_1', 'facets':[{'chave':'autor_exact', 'label': 'Autores'}]},
            ],
        }],
        'totalizadores':[
            {'label':'Autores com Instituição definida' , 'facet':{'instituicao_list':["*"]}, 'docs':{'url':'""', 'text':'snipet'}, 'type':['doc', 'main'], 'order':1},
            {'label':'Autores sem Instituição definida' , 'facet':{'-instituicao_list':["*"]}, 'docs':{'url':'""', 'text':'autor'}, 'type':['doc', 'main'], 'order':2},
        ],
    },
    ...
    'bv_empresas':{
        ...
        'omite_secoes':['outros_indicadores', 'busca', 'refine', 'sankey'], # Caso nao queira uma determinada secao no buscador.

        'campo_dinamico_busca':'cross_collection_bv_empresas',
        'facets_categorias':[
            {'groupBy':{'id':'class', 'label':'Classificação','order':0},
            'facetGroup':[
                {'label':'Município' , 'render':'barChart_1', 'facets':[{'chave':'municipio_cpd', 'label': 'Município'}]},
                {'label':'CNAE' , 'render':'barChart_1', 'facets':[{'chave':'lista_cnae', 'label': 'CNAE'}]},
            ]},
            {'groupBy':{'id':'temporal', 'label':'Temporal','order':1},
            'facetGroup':[
                {'label':'Acumulado por ano de entrada no Programa PIPE' , 'render':'barChart_1', 'facets':[{'chave':'ano_primeiro_processo', 'label': 'Entrada no programa PIPE'}]}
            ]}
        ],
        'totalizadores':[
            {'label':'Empresas com Projetos PIPE apoiados' , 'facet':{'quantidade_projetos':['[1 TO *]']}, 'docs':{'url':'absolute_url_pt_t', 'text':'razao_social'}, 'type':['doc', 'main'], 'order':2},
            {'label':'Empresa sem Projetos' , 'facet':{'quantidade_projetos':["0"]}, 'docs':{}, 'type':['main'], 'order':3},
    ...
    'bv_pesquisadores':{
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                {'label':'Instituição de afiliação' , 'render':'barChart_1', 'facets':[{'chave':'instituicao_afiliacao_exact', 'label': 'Instituição de afiliação'}]},
                {'label':'Quantidade de Processos' , 'render':'barChart_1', 'facets':[{'chave':'quantidade_processos', 'label': 'Quantidade de Processos'}]},
            ]},
            {'groupBy':{'id':'Pesquisador', 'label':'Gênero','order':1},
            'facetGroup':[
                {'label':'Gênero' , 'render':'barChart_1', 'facets':[{'chave':'sexo', 'label': 'Gênero'}]},
                {'label':'Nacionalidade (País)' , 'render':'barChart_1', 'facets':[{'chave':'nacionalidade', 'label': 'Nacionalidade (País)'}]},
            ]},
        ...
        'totalizadores':[
            ...
            {'label':'Pesquisadores (Beneficiário e/ou responsável)' , 'facet':{'*':["*"]}, 'docs':{'url':'url_pt', 'text':'snipet'}, 'type':['doc'],  'colunas': 12, 'order':0},
            #
            ...
            {'label':'Com Google Citations' , 'facet':{'google_citations':["*"]}, 'docs':{}, 'type':['main'], 'order':4},
    ...
    'pesquisa_pipe':{
        ...
        'omite_secoes':['documentos', 'outros_indicadores', 'busca', 'refine'], # Caso nao queira uma determinada secao no buscador.
        # 'id_index_from':'id_pesquisador',
        # 'id_index_to':'django_id',
        'facets_categorias':[
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'', 'facets':[{'chave':'prop_preenchido', 'label': 'Propriedade Intelecutal'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'parc_preenchido', 'label': 'Parceirias'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_preenchido', 'label': 'Governança'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'socio_f_preenchido', 'label': 'Socieconomico Financeiro'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'socio_p_preenchido', 'label': 'Socioeconomico Pessoal'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'aval_preenchido', 'label': 'Avaliação do programa PIPE'}]},
            ]},

            {'groupBy':{'id':'iden', 'label':'Identificação','order':1},
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'iden_participacao_capital_estrangeiro', 'label': 'Participação de capital estrangeiro'}]},
                ...
                {'label':'' , 'render':'', 'facets':[{'chave':'iden_mundanca_acionaria', 'label': 'Mudança Acionária'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'iden_respondente_responsavel', 'label': 'Respondente é o pesquisador responsável do projeto?'}]},
            ]},
            ...
            {'groupBy':{'id':'esfor_gastos', 'label':'Esforço de P&D e Inovação: Total de gastos com P&D realizados com recursos da empresa','order':3.1},
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DEPOIS2_valor_decorrencia_pipe', 'label': 'Depois 2'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DEPOIS1_valor_decorrencia_pipe', 'label': 'Depois 1'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DURANTE2_valor_decorrencia_pipe', 'label': 'Durante 2'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DURANTE1_valor_decorrencia_pipe', 'label': 'Durante 1'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_ANTES2_valor_decorrencia_pipe', 'label': 'Antes 2'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_ANTES1_valor_decorrencia_pipe', 'label': 'Antes 1'}]},
            ]},

            {'groupBy':{'id':'esfor_influ', 'label':'Esforço de P&D e Inovação: Influência dos recursos alocados pela FAPESP','order':3.2},
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DEPOIS2_GastosPD_fator_redundante', 'label': 'Depois 2'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DEPOIS1_GastosPD_fator_redundante', 'label': 'Depois 1'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DURANTE2_GastosPD_fator_redundante', 'label': 'Durante 2'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'esfo_DURANTE1_GastosPD_fator_redundante', 'label': 'Durante 1'}]},
            ]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'pess_escolaridade', 'label': 'Escolaridade'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'pess_experiencia', 'label': 'Experiência no tema (anos)'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'pess_formacao', 'label': 'Formação em gestão (na submissão)'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'pess_formacao_posterior', 'label': 'Formação em gestão (posteriormente)'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'resu_chegou_a_resultados', 'label': 'Resultados alcançados'}]},
            ]},

            {'groupBy':{'id':'pi', 'label':'Geração de patentes e PI','order':6},
            'facetGroup':[
                {'label':'Influência PIPE - Geração de Patentes' , 'render':'barChart_1', 'facets':[{'chave':'prop_registro_brasil_mu', 'label': 'Patentes'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'prop_registro_brasil_marcas', 'label': 'Marcas'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'prop_registro_brasil_sw', 'label': 'Software'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'prop_registro_brasil_ci', 'label': 'Circuitos Integrados'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'prop_registro_brasil_plantas', 'label': 'Cultivares de plantas'}]},
            ]},

            {'groupBy':{'id':'parc', 'label':'Parcerias','order':7},
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'parc_parcerias_institutos_universidades', 'label': 'Parceria com institutos/universidades'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'parc_parcerias_outros_atores', 'label': 'Parceria com outros atores'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'parc_influencia_pipe_inst_univ', 'label': 'Influência PIPE se parceria com inst/univ'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'parc_influencia_pipe_outros_atores', 'label': 'Influência PIPE se parceria com outros atores'}]},
            ]},

            {'groupBy':{'id':'govr', 'label':'Governança','order':8},
            'facetGroup':[
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_pdi_explicito', 'label': 'PDI Explicito'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_influencia_pipe_pdi_explicito', 'label': 'Influencia PIPE PDI explícito'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_regras_compliance', 'label': 'Regras de compliance'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_modelos_gestao', 'label': 'Modelos de gestão'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_organizacao_pdi', 'label': 'Organização PDI'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'gove_influencia_pipe_organizacao_pdi', 'label': 'Influência PIPE Organização PDI'}]},
            ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'', 'facets':[{'chave':'aval_crit_cand', 'label': 'Critérios da candidatura'}]},
                ...
                {'label':'' , 'render':'', 'facets':[{'chave':'aval_condi_fin', 'label': 'Condições do financiamento'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'aval_neg_pi', 'label': 'Negociação de Popriedade Intelectual	'}]},
                {'label':'' , 'render':'', 'facets':[{'chave':'aval_valor_apoio', 'label': 'Valor do apoio dado pela FAPESP	'}]},
            ]},


        ],
        'totalizadores':[
            {'label':'Média de gastos com P&D - Antes 1' , 'data_type':'currency', 'avg':'esfo_ANTES1_valor_decorrencia_pipe', 'order':1, 'docs':{}, 'type':['main']},
            ...
            {'label':'Patentes independentes do PIPE' , 'sum':'prop_registro_brasil_mu', 'order':4, 'docs':{}, 'type':['main']},
            {'label':'Patentes decorrentes do PIPE' , 'sum':'prop_registro_pipe_brasil_mu', 'order':5, 'docs':{}, 'type':['main']},


            {'label':'Projeto chegou a resultados' , 'facet':{'resu_chegou_a_resultados':["Sim"]}, 'docs':{}, 'type':['main'], 'order':2},
        ],
    },
    ...
    'inep_docentes':{
        # 'django_ct':'geral.pesquisador',
        'label': 'INEP - Docentes',
        'omite_secoes':['refine', 'busca', 'documentos', 'related_collections'], # Caso nao queira uma determinada secao no buscador.
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ano_vigencia_inep', 'label': 'Ano de vigência do INEP'}]},
            ]},

            {'groupBy':{'id':'docente', 'label':'Docente','order':1},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_NACIONALIDADE_DOCENTE', 'label': 'Nacionalidade'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CO_UF_NASCIMENTO', 'label': 'Estado natal'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CO_MUNICIPIO_NASCIMENTO', 'label': 'Município natal'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'DS_SEXO_DOCENTE', 'label': 'Gênero'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NU_ANO_DOCENTE_NASC', 'label': 'Ano de nascimento'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_COR_RACA_DOCENTE', 'label': 'Cor/Raça'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CO_ESCOLARIDADE_DOCENTE', 'label': 'Escolaridade'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'IN_DOCENTE_DEFICIENCIA', 'label': 'Deficiência física'}]},
            ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_CATEGORIA_ADMINISTRATIVA', 'label': 'Categoria Administrativa'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_ORGANIZACAO_ACADEMICA', 'label': 'Organização Acadêmica'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_CAPITAL_IES', 'label': 'IES localizada na capital?'}]},
            ]},

            {'groupBy':{'id':'regime_trabalho', 'label':'Condições de trabalho','order':3},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_SITUACAO_DOCENTE', 'label': 'Situação do docente'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_REGIME_TRABALHO', 'label': 'Regime de trabalho'}]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_GRAD_PRESENCIAL', 'label': 'Graduação Presencial'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_POS_EAD', 'label': 'EAD - Pós'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_POS_PRESENCIAL', 'label': 'Pós presencial'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_SEQUENCIAL', 'label': 'Curso sequencial'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_PESQUISA', 'label': 'Pequisa'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ATU_GRAD_PRESENCIAL', 'label': 'Graduação Presencial'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_BOLSA_PESQUISA', 'label': 'Possui bolsa de pesquisa'}]},
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_VISITANTE_IFES_VINCULO', 'label': 'Tipo de vínculo do docente visitante à IES'}]},
            ]},
        ],
        'totalizadores':[
            {'label':'Docentes nascidos no estado de São Paulo' , 'facet':{'CO_UF_NASCIMENTO':["35"]}, 'docs':{}, 'type':['main'], 'order':2},
    ...
    'inep_alunos':{
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NU_ANO_ALUNO_NASC', 'label': 'Ano de nascimento'}]},
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_NACIONALIDADE_ALUNO', 'label': 'Nacionalidade'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CO_MUNICIPIO_NASCIMENTO', 'label': 'Município nascimento'}]},
            ]},


            {'groupBy':{'id':'inf_acad', 'label':'Informações do aluno','order':2},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ANO_INGRESSO', 'label': 'Ano de ingresso'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'DS_NIVEL_ACADEMICO', 'label': 'Nível acadêmico'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_GRAU_ACADEMICO', 'label': 'Grau acadêmico'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'IN_ACESSO_PORTAL_CAPES', 'label': 'Acesso ao portal Capes'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'DS_MODALIDADE_ENSINO', 'label': 'Modalidade de ensino'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'QT_CARGA_HORARIA_INTEG', 'label': 'Carga horária'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_TURNO_ALUNO', 'label': 'Turno do aluno'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DS_ALUNO_SITUACAO', 'label': 'Situação do aluno'}]},
            ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NO_OCDE_AREA_GERAL', 'label': 'OCDE - Área geral'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NO_OCDE_AREA_DETALHADA', 'label': 'OCDE - Área detalhada'}]},
            ]},
        ],
        'totalizadores':[
        ],
    ...
    'fazenda_sp':{
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
            {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Fonte_de_Recursos', 'label': 'Fonte de Recursos'}]},
            ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Unidade_Gestora', 'label': 'Unidade Gestora'}]},
            ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Funcional_Program_tica', 'label': 'Funcional Programática'}]},
        ...
        'totalizadores':[
            {'label':'Dotação Inicial' , 'sum':'Dota__o_Inicial', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':1},
            {'label':'Dotação Atual' , 'sum':'Dota__o_Atual', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':2},
            {'label':'Empenhado' , 'sum':'Empenhado', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':3},
            {'label':'Liquidado' , 'sum':'Liquidado', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':4},
            {'label':'Pago' , 'sum':'Pago', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':5},
            {'label':'Pago_Restos' , 'sum':'Pago_Restos', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':6},
        ],
    },
    ...
    'rais':{
        ...
        'facets_categorias':[
            ...
            'facetGroup':[
                ...
                {'label':'Idade' , 'render':'halfPieChart', 'facets':[{'chave':'Ind_Portador_Defic', 'label': 'Ind_Portador_Defic'}]},
                {'label':'Idade' , 'render':'barChart_1', 'facets':[{'chave':'Ra_a_Cor', 'label': 'Raça / Cor'}]},
                {'label':'Idade' , 'render':'barChart_1', 'facets':[{'chave':'Faixa_Et_ria', 'label': 'Faixa Etária'}]},
                {'label':'Idade' , 'render':'barChart_1', 'facets':[{'chave':'Escolaridade_ap_s_2005', 'label': 'Escolaridade após 2005'}]},
                {'label':'Idade' , 'render':'halfPieChart', 'facets':[{'chave':'Sexo_Trabalhador', 'label': 'Sexo'}]},
                {'label':'Idade' , 'render':'barChart_1', 'facets':[{'chave':'Tipo_Defic', 'label': 'Tipo_Defic'}]},
                {'label':'Idade' , 'render':'barChart_1', 'facets':[{'chave':'Ano_Chegada_Brasil', 'label': 'Ano de chegada ao Brasil'}]},
            ...
            'facetGroup':[
                ...
                {'label':'Nacionalidade' , 'render':'barChart_1', 'facets':[{'chave':'Nacionalidade', 'label': 'Nacionalidade'}]},
                {'label':'Distritos_SP' , 'render':'barChart_1', 'facets':[{'chave':'Distritos_SP', 'label': 'Distrito SP'}]},
                {'label':'Bairros_SP' , 'render':'barChart_1', 'facets':[{'chave':'Bairros_SP', 'label': 'Bairro SP'}]},
            ]},
            {'groupBy':{'id':'afastamento', 'label':'Afastamento / Desligamento',  'order':2},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Causa_Afastamento_1', 'label': 'Causa Afastamento 1'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Causa_Afastamento_2', 'label': 'Causa Afastamento 2'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Causa_Afastamento_3', 'label': 'Causa Afastamento 3'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Motivo_Desligamento', 'label': 'Motivo Desligamento'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Qtd_Dias_Afastamento', 'label': 'Qtd_Dias_Afastamento'}]},
            ]},

            {'groupBy':{'id':'ocupa_cnae', 'label':'Ocupação / CNAE',  'order':3},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CBO_Ocupa__o_2002', 'label': 'CBO_Ocupa__o_2002'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CNAE_95_Classe', 'label': 'CNAE_95_Classe'}]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'IBGE_Subsetor', 'label': 'IBGE_Subsetor'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Tipo_Estab', 'label': 'Tipo_Estab'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Tipo_Admiss_o', 'label': 'Tipo_Admiss_o'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Tipo_Estab', 'label': 'Tipo_Estab'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'Tamanho_Estabelecimento', 'label': 'Tamanho_Estabelecimento'}]},
            ]},
        ],
        'totalizadores':[
            {'label':'Vl_Remun_Dezembro_Nom' , 'sum':'Vl_Remun_Dezembro_Nom', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':1},
            {'label':'Vl_Remun_Dezembro__SM_' , 'sum':'Vl_Remun_Dezembro__SM_', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':2},
            {'label':'Vl_Remun_M_dia_Nom' , 'sum':'Vl_Remun_M_dia_Nom', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':3},
            {'label':'Vl_Remun_M_dia__SM_' , 'sum':'Vl_Remun_M_dia__SM_', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':4},
            {'label':'Vl_Rem_Janeiro_CC' , 'sum':'Vl_Rem_Janeiro_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':5},
            {'label':'Vl_Rem_Fevereiro_CC' , 'sum':'Vl_Rem_Fevereiro_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':6},
            {'label':'Vl_Rem_Mar_o_CC' , 'sum':'Vl_Rem_Mar_o_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':7},
            {'label':'Vl_Rem_Abril_CC' , 'sum':'Vl_Rem_Abril_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':8},
            {'label':'Vl_Rem_Maio_CC' , 'sum':'Vl_Rem_Maio_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':9},
            {'label':'Vl_Rem_Junho_CC' , 'sum':'Vl_Rem_Junho_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':10},
            {'label':'Vl_Rem_Julho_CC' , 'sum':'Vl_Rem_Julho_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':10},
            {'label':'Vl_Rem_Agosto_CC' , 'sum':'Vl_Rem_Agosto_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':10},
            {'label':'Vl_Rem_Setembro_CC' , 'sum':'Vl_Rem_Setembro_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':10},
            {'label':'Vl_Rem_Outubro_CC' , 'sum':'Vl_Rem_Outubro_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':10},
            {'label':'Vl_Rem_Novembro_CC' , 'sum':'Vl_Rem_Novembro_CC', 'docs':{}, 'data_type':'currency', 'type':['main'], 'order':11},
        ],
    },
    ...
    'lattes':{
        ...
        'omite_secoes':['refine', 'documentos', 'related_collections'], # Caso nao queira uma determinada secao no buscador.
        ...
        'facets_categorias':[
            ...
            {'groupBy':{'id':'pessoais', 'label':'Pessoais',  'order':1},
            'facetGroup':[
            {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'AREAS-DO-CONHECIMENTO-DE-ATUACAO_FACET', 'label': 'Área do conhecimento (atuação)'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_GRADUACOES', 'label': 'Qt. de Graduações'}]},
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'GRADUACAO_STATUS-DO-CURSO', 'label': "Graduação status"}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'GRADUACAO_NOME-CURSO', 'label': 'Curso'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'GRADUACAO_ANO-DE-INICIO', 'label': 'Ano Início'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'GRADUACAO_ANO-DE-CONCLUSAO', 'label': 'Ano Conclusão'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'GRADUACAO_FLAG-BOLSA', 'label': 'Graduação com bolsa'}]},
            ]},

            {'groupBy':{'id':'especializacao', 'label':'Especialização',  'order':3},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_ESPECIALIZACOES', 'label': 'Qt. de Especializações'}]},
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'ESPECIALIZACAO_STATUS-DO-CURSO', 'label': "Especialização status"}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'GRADUACAO_NOME-CURSO', 'label': 'Curso'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ESPECIALIZACAO_ANO-DE-INICIO', 'label': 'Ano Início'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ESPECIALIZACAO_ANO-DE-CONCLUSAO', 'label': 'Ano Conclusão'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'ESPECIALIZACAO_FLAG-BOLSA', 'label': 'Especialização com bolsa'}]},
            ]},

            {'groupBy':{'id':'mestrado', 'label':'Mestrado',  'order':4},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_MESTRADOS', 'label': 'Qt. de Mestrados'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'MESTRADO_STATUS-DO-CURSO', 'label': 'Mestrado status'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'MESTRADO_FLAG-BOLSA', 'label': 'Mestrado com Bolsa'}]},
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'MESTRADO_ANO-DE-INICIO', 'label': 'Ano Início'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'MESTRADO_ANO-DE-CONCLUSAO', 'label': 'Ano Conclusão'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'MESTRADO_ESPECIALIDADE', 'label': 'Áreas especialidade'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'MESTRADO_AREAS-DO-CONHECIMENTO_FACET', 'label': 'Áreas do conhecimento'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_DOUTORADOS', 'label': 'Qt. de Doutorados'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'DOUTORADO_STATUS-DO-CURSO', 'label': 'Doutorado status'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DOUTORADO_NIVEL', 'label': 'Nível'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DOUTORADO_ANO-DE-INICIO', 'label': 'Ano início'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DOUTORADO_ANO-DE-CONCLUSAO', 'label': 'Ano conclusão'}]},
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'DOUTORADO_FLAG-BOLSA', 'label': 'Doutorado com bolsa'}]},
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DOUTORADO_AREAS-DO-CONHECIMENTO_FACET', 'label': 'Área do conhecimento'}]},
            ]},
            {'groupBy':{'id':'pos_doutorado', 'label':'Pós-doutorado',  'order':6},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_POS-DOUTORADOS', 'label': 'Qt. de Pós-doutorado'}]},
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'POS-DOUTORADO_STATUS-DO-CURSO', 'label': 'Pós-doutorado Status'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'POS-DOUTORADO_NIVEL', 'label': 'Nível'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'POS-DOUTORADO_ANO-DE-INICIO', 'label': 'Ano início'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'POS-DOUTORADO_ANO-DE-CONCLUSAO', 'label': 'Ano conclusão'}]},
                ...
                {'label':'' , 'render':'halfPieChart', 'facets':[{'chave':'POS-DOUTORADO_FLAG-BOLSA', 'label': 'Pós-doutorado com Bolsa'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'DOUTORADO_PALAVRAS-CHAVE', 'label': 'Palavras chave'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'POS-DOUTORADO_ESPECIALIDADE', 'label': 'Área especialiadde'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'POS-DOUTORADO_AREAS-DO-CONHECIMENTO_FACET', 'label': 'Área do conhecimento'}]},
            ]},
            {'groupBy':{'id':'livre_docencia', 'label':'Livre-docência',  'order':7},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_LIVRE-DOCENCIAS', 'label': 'Qt. de Livre-docência'}]},
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'LIVRE-DOCENCIA_ANO-DE-OBTENCAO-DO-TITULO', 'label': 'Ano de obtenção do título'}]},
            ]},
            {'groupBy':{'id':'atuacao_profissional', 'label':'Atuação Profissional',  'order':8},
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_ATUACOES-PROFISSIONAIS', 'label': 'Qt. de atuações profissionais'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ATUACAO-PROFISISONAL_ENQUADRAMENTOS', 'label': 'Enquadramentos'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'ATUACAO-PROFISISONAL_TIPOS-DE-VINCULOS', 'label': 'Tipos de vínculo'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_CONSELHO-COMISSAO-E-CONSULTORIA', 'label': 'Cons., comiss., consult. (Qt)'}]},
                # {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'CONSELHO-COMISSAO-E-CONSULTORIA_ESPECIFICACAO', 'label': 'Cons., comiss., consult.'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'NUM_PARTICIPACAO-EM-PROJETO', 'label': 'Projetos (Qt)'}]},
    ...
    'wos':{
        ...
        'omite_secoes':['outros_indicadores', 'busca', 'refine', 'sankey', 'bubblechart'], # Caso nao queira uma determinada secao no buscador.

        'campo_dinamico_busca':'cross_collection_wos',
        'facets_categorias':[
            {'groupBy':{'id':'categoria', 'label':'Categoria','order':1},
                'facetGroup':[
                    {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'research-areas', 'label': 'Áreas de pesquisa'}]},
                    {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'web-of-science-categories', 'label': 'Categorias WoS'}]},
                ]},
            ...
            'facetGroup':[
                ...
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'publisher_journal_volume', 'label': 'Editora'}]},
            ...
            'facetGroup':[
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'number-of-cited-references', 'label': 'Referências citadas'}]},
                {'label':'' , 'render':'barChart_1', 'facets':[{'chave':'times-cited', 'label': 'Número de citações'}]},
            ]},
            # Campos buscaveis
...
MULTILEVEL_BARCHART_1 = {
    ...
    'pesquisa_pipe':{
        ...
        'y_axis':[
            ...
            {'value':'esfo_DURANTE1_valor_decorrencia_pipe', 'label':'esfo_DURANTE1_valor_decorrencia_pipe - Durante 1'},
            {'value':'esfo_DURANTE2_valor_decorrencia_pipe', 'label':'esfo_DURANTE2_valor_decorrencia_pipe - Durante 2'},
            {'value':'esfo_DEPOIS1_valor_decorrencia_pipe', 'label':'esfo_DEPOIS1_valor_decorrencia_pipeo - Depois 1'},
